-- 🗄️ DATABASE MIGRATION: Version 4 to Version 5
-- Pembersihan schema sesuai tabel asli di Supabase
...
-- ✅ Migration completed!
-- Database schema sekarang sudah bersih dan sesuai dengan Supabase asli
